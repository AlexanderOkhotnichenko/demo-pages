...
import demoTwo from "./demo-two.module.scss";
...
export function DemoTwo() {
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      timeline.fromTo(`.${demoTwo.content__content_mass_table__tr}.${demoTwo.i_2}`, {
        width: 0,
        duration: 1,
        opacity: 0,
        ease: "power2.out"
      ...
      timeline.fromTo(`.${demoTwo.content__content_bubbles__bubble}.${demoTwo.i_2}`, {
        opacity: 0,
        scale: 0,
        ease: "back.out(2)",
      }, {
          ...
          <div className={demoTwo.content__wrapper}>
            <div className={demoTwo.content__box}>
              <div className={demoTwo.content__content_bubbles}>
                ...
                <div className={`${demoTwo.content__content_bubbles__bubble} ${demoTwo.i_2}`}></div>
                ...
                <div className={`${demoTwo.content__content_mass_row} ${demoTwo.i_2}`}>
                  ...
                  <table className={demoTwo.content__content_mass_table}>
                    <tbody className={demoTwo.content__content_mass_table__body}>
                      ...
                      <tr className={`${demoTwo.content__content_mass_table__tr} ${demoTwo.i_2}`}>
