...
export function Footer() {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      timeline.from(`.${footer.box}.${footer.logo}`, {
        animation: gsap.to(
          CSSRulePlugin.getRule(`.${footer.box}.${footer.logo}::before`),
          {
            duration: 2,
            ease: "none",
            cssRule: {
  ...
  return (
      <footer className={footer.footer} data-scroll-section>
